// src/utils/api.js
export const API_URL = 'http://www.ycountry-eclaim.admin.local:8001';
export const ECLAIM_URL = 'http://www.ycountry-eclaim.core.local:8002';
export const CUSTOMER_PORTAL = 'http://www.ycountry-eclaim.local:8000';
...
export const makeApiCallCustomer = async (endpoint, options = {}) => {
  try {
    const response = await fetch(`${CUSTOMER_PORTAL}/${endpoint}`, options);
